...
class InterfazSimulacionTermica(ctk.CTk):
    def __init__(self):
        ...
        # Frame principal
        self.frame = ctk.CTkFrame(self, fg_color="#011526")
        ...
        # Botón para graficar
        self.button_graficar = ctk.CTkButton(self.frame_botones, fg_color="#038C65", hover_color="#02735E", text="Generar Gráfica", command=self.simular_y_graficar)
